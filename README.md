Employement insight Project using powerBI
...
This makes it difficult for leaders and workforce planners to understand how employment is changing over time. 
The purpose of the Employment Insights dashboard is to help executives and HR teams easily track key workforce metrics within any selected time period, such as total headcount,
open positions, turnover, and workforce distribution. However, working with this data is challenging because measures are not always consistent, reports are spread across multiple sources,
and trends are not easy to visualise. For example,key employees indicator breakdown can be unclear.
...
The dashboard helps managers and leaders quickly understand workforce performance and make better, data-driven decisions.
...
3. Cleaned and transformed the data in Power Query by fixing errors, removing duplicates, and standardising fields such as names, regions, and date formats.
4. Built relationships between tables, including active and inactive relationships where required.
5. Completed the ETL (Extract, Transform, Load) process to prepare the data for analysis.
...
along with the growth of employee hired over the course of the year. 
It also talks about the key employee indicator breakdown where it shows the total number of employees at each cost centre,thier average salary,average tenor(years)spent,
...
6. Explored major analytical visuals and how to create comprehensive reports.
7. Completed all of this independently. Although it was challenging, I persevered and I think that deserves some recognition 😎🎂.
